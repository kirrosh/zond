...
Scope decision (2026-07-06): Option 1 — cut the three autonomous layers (severity calibrator, anti-fp, annotate-auto guess-engine); KEEP deterministic built-in per-check severity (5xx=high) as a default the agent overrides. Full severity-neutralization (Option 2) deferred.
<!-- SECTION:NOTES:END -->
