...
- [ ] Секция «Secrets & redaction» в skill'е.
- [ ] Iron rule про не-читать `.secrets.yaml` напрямую.
- [ ] Entry-point row про `zond doctor --json`.
- [ ] Phase про safe sharing с `--redact-identity`.
- [ ] Skill в `init` template обновлён.
- [ ] AGENTS.md обновлён.
