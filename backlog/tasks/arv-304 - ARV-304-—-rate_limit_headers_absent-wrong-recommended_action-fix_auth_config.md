...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 rate_limit_headers_absent finding uses an enum that an agent can route on as a backend-side issue, not as a caller-side fix
- [ ] #2 test covers the per-finding recommended_action mapping
<!-- AC:END -->
