  ...
  test("emits a single-file HTML with hero, KPIs, failure card, curl, coverage", () => {
    ...
    const html = renderHtmlReport({
      run: {
        ...
        environment: "staging",
        duration_ms: 1234,
        collection_id: null, session_id: null, tags: null, run_kind: "regular" as const,
      },
  ...
  test("escapes HTML in user-controlled fields (XSS guard)", () => {
    const html = renderHtmlReport({
      run: {
        ...
        duration_ms: null, collection_id: null, session_id: null, tags: null, run_kind: "regular" as const,
      },
      results: [{
  ...
  test("renders pass-only run with empty-state failures section", () => {
    const html = renderHtmlReport({
      run: {
        ...
        duration_ms: 1000, collection_id: null, session_id: null, tags: null, run_kind: "regular" as const,
      },
      results: [
