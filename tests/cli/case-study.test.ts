  ...
  test("fills the template with provenance + classification + spec snippet + curl", () => {
    ...
    const md = renderCaseStudy({
      ...
      run: {
        ...
        environment: "staging", duration_ms: 1234, collection_id: 1, session_id: null, tags: null,
      },
      specTitle: "Pets API",
      specVersion: "v1.0.0",
  ...
  test("uses TODO placeholders when spec snippet / classification missing", () => {
    const md = renderCaseStudy({
      ...
      run: {
        ...
        duration_ms: null, collection_id: null, session_id: null, tags: null,
      },
      zondVersion: "v",
    });
  ...
  test("env_issue gets a different TL;DR phrasing than definitely_bug", () => {
    const base = (fc: "env_issue" | "definitely_bug") => renderCaseStudy({
      ...
      run: {
        ...
        environment: null, duration_ms: null, collection_id: null, session_id: null, tags: null,
      },
      zondVersion: "v",
    });
